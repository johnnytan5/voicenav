...
class extraction:
    ...
    def check_trigger(self):
        ...
        if self.latest_command == "scan" and self.latest_mode == "scanning" and not self.has_processed:
    ...
    def image_callback(self, msg):
        if not self.has_processed and self.latest_command == "scan" and self.latest_mode == "scanning":
            try:
